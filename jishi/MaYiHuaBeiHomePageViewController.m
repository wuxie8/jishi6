//
//  MaYiHuaBeiHomePageViewController.m
//  jishi
//
...
@interface MaYiHuaBeiHomePageViewController ()<ASValueTrackingSliderDataSource>

@property(strong, nonatomic)UIView*loadHeadView;
@property(strong, nonatomic)UIView *loadMiddleView;
@end

@implementation MaYiHuaBeiHomePageViewController
{
    UILabel *label2;
    UILabel *label4;
    UILabel *label6;
