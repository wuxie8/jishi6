...
@interface NewHomePageViewController ()<ASValueTrackingSliderDataSource>
...
{
     if (!_loadHeadView) {
    _loadHeadView=[[UIView alloc]initWithFrame:CGRectMake(0 , 0, WIDTH, 180)];
    _loadHeadView.backgroundColor=AppButtonbackgroundColor;
    UIView *blueview=[[UIView alloc]initWithFrame:CGRectMake(10, 10, WIDTH-10*2, 160)];
    ...
    UILabel *testLabel = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-250, 60, 200, 80)];
...
//        
        ...
        UIView *view1 =[[UIView alloc]initWithFrame:CGRectMake(0,  CGRectGetMaxY(view.frame), WIDTH, 210)];
        ...
        UIButton *but=[[UIButton alloc]initWithFrame:CGRectMake(18, CGRectGetMaxY(lab2.frame)+50, WIDTH-36, 50)];
